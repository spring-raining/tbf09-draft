...
![](images/a230c7c4-ab76-4fe7-a47c-fcdaf37ccb94.jpg){#fig-a230c7c4-ab76-4fe7-a47c-fcdaf37ccb94}

theme-academic では、Markdown で構造化された文書を書くだけでいい感じにレポートらしい PDF が出力できることを目指しています。サンプルをいくつか紹介しましょう。

![https://github.com/vivliostyle/themes/blob/master/packages/@vivliostyle/theme-academic/example/fet.md より](images/c09197af-5aea-4151-86e4-cd2f8105ce39.jpg){.fig #fig-c09197af-5aea-4151-86e4-cd2f8105ce39}

![https://github.com/vivliostyle/themes/blob/master/packages/@vivliostyle/theme-academic/example/microcomputer.md より](images/39de9443-ad8d-4f2b-a1f9-86eacd79c53c.jpg){.fig #fig-39de9443-ad8d-4f2b-a1f9-86eacd79c53c}
...
| 基本的な要素 | 記法 | 出力（PDF） |
| --- | --- | --- |
| 見出し | GFM 準拠。`.nocounter` でカウンタを削除（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L182-L187)） | <img src="images/a4bc4bf4-bafa-459d-b381-857d758a701c.png"> |
| 箇条書き | GFM 準拠。`ol.nostyle` `ul.nostyle` で箇条書きの記号を削除 | <img src="images/315c1674-7ab7-4143-83fb-70b40e65b5b0.png"> |
| 参考文献リスト | `ol.reference` に HTML をそのまま書く（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L189-L194)） | <img src="images/ed95e8fb-7f77-4a74-89c7-0b15ccaea8dc.png"> |
| 図 | [VFM 準拠](https://vivliostyle.org/ja/make-books-with-create-book/#%E7%94%BB%E5%83%8F%E3%81%AE%E3%82%B5%E3%82%A4%E3%82%BA%E3%81%A8%E3%82%AD%E3%83%A3%E3%83%97%E3%82%B7%E3%83%A7%E3%83%B3)（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L42)） | <img src="images/e0e284bf-b751-422b-9f86-3b39a10abbc5.png"> |
| 表 | 表キャプションが未実装のため、HTML をそのまま書く（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L66-L105)）。キャプション無しなら GFM 準拠 | <img src="images/1f445380-d999-4c6e-b3ec-b43cab5999eb.png"> |
| 参考文献・図表カウンタの参照 | VFM で仕様が決まっていないため、参照<span style="font-family: body">元</span>に `<a href="#id" data-ref="fig"></a>`、参照先に `<span id="id"></span>` を書くことで代用（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L25-L35)） |  |
| 後注 | [VFM 準拠](https://vivliostyle.org/ja/make-books-with-create-book/#%E5%BE%8C%E6%B3%A8) | <img src="images/89850f6f-2912-4a49-b634-291c8603615d.png"> |
| 右・中央・左寄せ | `.right` `.center` `.left` | <img src="images/4efbac99-7507-485e-a51f-fc611e7da766.png"> |
| 数式 | KaTeX の記法が使える（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L155-L157)） | <img src="images/451f19a4-0df6-4e57-aa21-d0ef0fbb87ab.png"> |
| ソースコード | prism.js を使用（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/microcomputer.md#L77-L101)） | <img src="images/07a6c20b-6901-473a-80c2-2642be25787e.png"> |
| 囲み | `.frame`（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/microcomputer.md#L75-L103)） | <img src="images/f275ff0f-345a-49c2-bd28-d56d4250d5a8.png"> |
| タイトル下の著者情報など | `.author` 内に箇条書き（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/fet.md#L7-L10)） | <img src="images/5ac7cbdc-0faa-4848-98ef-7af5e4e5f5f9.png"> |
| ヘッダー・フッターのテキスト | SCSS の `$page-top-left` などの変数で指定。後述 | <img src="images/c3067552-cacf-4f39-b04c-d29d4d74acc1.png"> |
| 表紙の有無 | SCSS の `$cover` 変数で指定。`section.cover` 要素が表紙になり、表紙はページ番号がつかない（[例](https://github.com/vivliostyle/themes/blame/700d2567bd232b697f2935c95f174548f7cbc46c/packages/%40vivliostyle/theme-academic/example/microcomputer.md#L5-L17)）。後述 | <img src="images/1c4f64ec-c728-4d20-9338-2725d00ca6df.png"> |
...
![](images/dc546b4c-b504-44ff-8afe-608432241fc8.png){#fig-dc546b4c-b504-44ff-8afe-608432241fc8}
